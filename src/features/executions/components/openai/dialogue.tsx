...
export const OpenAIDialogue = ({
    ...
    const { data: credentials, isLoading: isLoadingCredentials } = useCredentialsByType(CredentialTypeValues.OPENAI);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure the OpenAI node settings below.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
